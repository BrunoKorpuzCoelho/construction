# -*- coding: utf-8 -*-
{
    ...
    'assets': {
        'web.assets_backend': [
            'construction_boq_new/static/src/scss/boq_editor.scss',
            'construction_boq_new/static/src/components/boq_editor/boq_editor.js',
            'construction_boq_new/static/src/components/boq_editor/boq_editor.xml',
        ],
    },
    'installable': True,
    'auto_install': False,
